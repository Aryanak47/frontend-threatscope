        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-center">
          ...
          <div>
            <div className="text-center lg:text-left mb-8">
              ...
              <p className="text-xl text-muted-foreground">
                Sign in to your ThreatScope account to continue your security investigations
              </p>
            </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="h-4 w-4 text-security-600 focus:ring-security-500 border-border rounded"
                    />
                  ...
                  <Link 
                    ...
                    className="text-sm text-security-600 hover:text-security-700 underline"
                  >
                    Forgot password?
                  </Link>
                </div>
          ...
          <div className="space-y-8">
            <div className="text-center lg:text-left">
              <h2 className="text-3xl font-bold mb-4">Why Choose ThreatScope?</h2>
              <p className="text-lg text-muted-foreground">
                The most comprehensive OSINT platform for security professionals
              </p>
            </div>
            ...
            <div className="space-y-6">
              <Card className="p-6">
                <div className="flex items-center space-x-4 mb-3">
                  <div className="p-2 bg-security-50 dark:bg-security-950 rounded-lg">
                    <Globe className="h-6 w-6 text-security-600" />
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold">14B+ Records</h3>
                    <p className="text-sm text-muted-foreground">Comprehensive breach database</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">
                  Search across billions of records from 500+ data sources including breaches, stealer logs, and public data.
                </p>
              </Card>

              <Card className="p-6">
                <div className="flex items-center space-x-4 mb-3">
                  <div className="p-2 bg-intelligence-50 dark:bg-intelligence-950 rounded-lg">
                    <Zap className="h-6 w-6 text-intelligence-600" />
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold">Lightning Fast</h3>
                    <p className="text-sm text-muted-foreground">Sub-200ms response times</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">
                  Advanced indexing and caching ensure you get results instantly, no matter the complexity of your search.
                </p>
              </Card>
              ...
              <Card className="p-6">
                <div className="flex items-center space-x-4 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Zero data retention</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">
              ...
              <Card className="p-6">
                <div className="flex items-center space-x-4 mb-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold">Trusted by 10K+</h3>
                    <p className="text-sm text-muted-foreground">Security professionals worldwide</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">
                  Join Fortune 500 companies, government agencies, and cybersecurity firms using ThreatScope daily.
                </p>
              </Card>
            </div>
